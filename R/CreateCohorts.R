...
#
# This file is part of Ohdsi2020StudyathonCohortDiagnosticsPCE
#
...
.createCohorts <- function(connection,
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "Ohdsi2020StudyathonCohortDiagnosticsPCE")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "Ohdsi2020StudyathonCohortDiagnosticsPCE")
